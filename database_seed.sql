...
('t1t1t1t1-1111-1111-1111-111111111111', 'VIP', 5999.00, 100, 100, CURRENT_TIMESTAMP, 'e1e1e1e1-1111-1111-1111-111111111111'),
('t1t1t1t1-1112-1111-1111-111111111111', 'Premium', 3999.00, 200, 200, CURRENT_TIMESTAMP, 'e1e1e1e1-1111-1111-1111-111111111111'),
('t1t1t1t1-1113-1111-1111-111111111111', 'General', 1999.00, 500, 500, CURRENT_TIMESTAMP, 'e1e1e1e1-1111-1111-1111-111111111111'),
('t1t1t1t1-1114-1111-1111-111111111111', 'Early Bird', 1499.00, 200, 180, CURRENT_TIMESTAMP, 'e1e1e1e1-1111-1111-1111-111111111111');

-- Classical Music Evening
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-2221-1111-1111-111111111111', 'VIP', 2999.00, 50, 50, CURRENT_TIMESTAMP, 'e1e1e1e1-2222-2222-2222-222222222222'),
('t1t1t1t1-2222-1111-1111-111111111111', 'Standard', 1499.00, 150, 150, CURRENT_TIMESTAMP, 'e1e1e1e1-2222-2222-2222-222222222222'),
('t1t1t1t1-2223-1111-1111-111111111111', 'Balcony', 999.00, 100, 100, CURRENT_TIMESTAMP, 'e1e1e1e1-2222-2222-2222-222222222222');

-- Tech Summit 2026
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-3331-1111-1111-111111111111', 'Full Conference Pass', 8999.00, 500, 450, CURRENT_TIMESTAMP, 'e1e1e1e1-3333-3333-3333-333333333333'),
('t1t1t1t1-3332-1111-1111-111111111111', 'Single Day Pass', 3499.00, 300, 280, CURRENT_TIMESTAMP, 'e1e1e1e1-3333-3333-3333-333333333333'),
('t1t1t1t1-3333-1111-1111-111111111111', 'Student Pass', 1999.00, 200, 200, CURRENT_TIMESTAMP, 'e1e1e1e1-3333-3333-3333-333333333333'),
('t1t1t1t1-3334-1111-1111-111111111111', 'Virtual Access', 999.00, 1000, 1000, CURRENT_TIMESTAMP, 'e1e1e1e1-3333-3333-3333-333333333333');

-- Healthcare Innovation Conference
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-4441-1111-1111-111111111111', 'Professional', 12999.00, 300, 300, CURRENT_TIMESTAMP, 'e1e1e1e1-4444-4444-4444-444444444444'),
('t1t1t1t1-4442-1111-1111-111111111111', 'Academic', 6999.00, 150, 150, CURRENT_TIMESTAMP, 'e1e1e1e1-4444-4444-4444-444444444444'),
('t1t1t1t1-4443-1111-1111-111111111111', 'Virtual Only', 2999.00, 500, 500, CURRENT_TIMESTAMP, 'e1e1e1e1-4444-4444-4444-444444444444');

-- Chennai Cricket Championship Finals
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-5551-1111-1111-111111111111', 'Pavilion', 3999.00, 200, 150, CURRENT_TIMESTAMP, 'e1e1e1e1-5555-5555-5555-555555555555'),
('t1t1t1t1-5552-1111-1111-111111111111', 'East Stand', 1999.00, 500, 400, CURRENT_TIMESTAMP, 'e1e1e1e1-5555-5555-5555-555555555555'),
('t1t1t1t1-5553-1111-1111-111111111111', 'West Stand', 1999.00, 500, 480, CURRENT_TIMESTAMP, 'e1e1e1e1-5555-5555-5555-555555555555'),
('t1t1t1t1-5554-1111-1111-111111111111', 'General', 799.00, 1000, 1000, CURRENT_TIMESTAMP, 'e1e1e1e1-5555-5555-5555-555555555555');

-- Marathon Chennai 2026
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-6661-1111-1111-111111111111', 'Full Marathon', 1999.00, 500, 500, CURRENT_TIMESTAMP, 'e1e1e1e1-6666-6666-6666-666666666666'),
('t1t1t1t1-6662-1111-1111-111111111111', '10K Run', 799.00, 1000, 920, CURRENT_TIMESTAMP, 'e1e1e1e1-6666-6666-6666-666666666666'),
('t1t1t1t1-6663-1111-1111-111111111111', '5K Fun Run', 499.00, 2000, 2000, CURRENT_TIMESTAMP, 'e1e1e1e1-6666-6666-6666-666666666666');

-- Digital Marketing Masterclass
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-7771-1111-1111-111111111111', 'Premium (with Materials)', 4999.00, 50, 45, CURRENT_TIMESTAMP, 'e1e1e1e1-7777-7777-7777-777777777777'),
('t1t1t1t1-7772-1111-1111-111111111111', 'Standard', 2999.00, 100, 100, CURRENT_TIMESTAMP, 'e1e1e1e1-7777-7777-7777-777777777777');

-- Photography Workshop
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-8881-1111-1111-111111111111', 'Premium (with Equipment)', 5999.00, 20, 20, CURRENT_TIMESTAMP, 'e1e1e1e1-8888-8888-8888-888888888888'),
('t1t1t1t1-8882-1111-1111-111111111111', 'Standard (BYO Equipment)', 3499.00, 30, 28, CURRENT_TIMESTAMP, 'e1e1e1e1-8888-8888-8888-888888888888');

-- Shakespeare's Hamlet
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-9991-1111-1111-111111111111', 'Stalls', 1999.00, 80, 80, CURRENT_TIMESTAMP, 'e1e1e1e1-9999-9999-9999-999999999999'),
('t1t1t1t1-9992-1111-1111-111111111111', 'Circle', 1299.00, 100, 100, CURRENT_TIMESTAMP, 'e1e1e1e1-9999-9999-9999-999999999999'),
('t1t1t1t1-9993-1111-1111-111111111111', 'Balcony', 799.00, 120, 120, CURRENT_TIMESTAMP, 'e1e1e1e1-9999-9999-9999-999999999999');

-- Chennai Food Festival 2026
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-aaa1-1111-1111-111111111111', 'VIP Food Pass', 2999.00, 200, 200, CURRENT_TIMESTAMP, 'e1e1e1e1-aaaa-aaaa-aaaa-aaaaaaaaaaaa'),
('t1t1t1t1-aaa2-1111-1111-111111111111', 'General Entry', 499.00, 5000, 4800, CURRENT_TIMESTAMP, 'e1e1e1e1-aaaa-aaaa-aaaa-aaaaaaaaaaaa'),
('t1t1t1t1-aaa3-1111-1111-111111111111', 'Family Pass (4 people)', 1499.00, 1000, 1000, CURRENT_TIMESTAMP, 'e1e1e1e1-aaaa-aaaa-aaaa-aaaaaaaaaaaa');

-- Art & Design Expo 2026
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-bbb1-1111-1111-111111111111', 'Collector Pass', 1999.00, 50, 50, CURRENT_TIMESTAMP, 'e1e1e1e1-bbbb-bbbb-bbbb-bbbbbbbbbbbb'),
('t1t1t1t1-bbb2-1111-1111-111111111111', 'Standard Entry', 499.00, 500, 500, CURRENT_TIMESTAMP, 'e1e1e1e1-bbbb-bbbb-bbbb-bbbbbbbbbbbb'),
('t1t1t1t1-bbb3-1111-1111-111111111111', 'Student Entry', 199.00, 300, 300, CURRENT_TIMESTAMP, 'e1e1e1e1-bbbb-bbbb-bbbb-bbbbbbbbbbbb');

-- Stand-Up Comedy Night
INSERT INTO ticket_categories (id, name, price, total_seats, available_seats, created_at, event_id) VALUES
('t1t1t1t1-ccc1-1111-1111-111111111111', 'Front Row', 2499.00, 20, 15, CURRENT_TIMESTAMP, 'e1e1e1e1-cccc-cccc-cccc-cccccccccccc'),
('t1t1t1t1-ccc2-1111-1111-111111111111', 'Premium', 1499.00, 100, 85, CURRENT_TIMESTAMP, 'e1e1e1e1-cccc-cccc-cccc-cccccccccccc'),
('t1t1t1t1-ccc3-1111-1111-111111111111', 'Standard', 999.00, 200, 200, CURRENT_TIMESTAMP, 'e1e1e1e1-cccc-cccc-cccc-cccccccccccc');
...
('f1f1f1f1-1111-1111-1111-111111111111', 'BOOK-A1B2C3D4', 2, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-1111-1111-1111-111111111111', 't1t1t1t1-1114-1111-1111-111111111111'),
('f1f1f1f1-1112-1111-1111-111111111111', 'BOOK-E5F6G7H8', 1, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-1111-1111-1111-111111111111', 't1t1t1t1-6662-1111-1111-111111111111'),

-- Bob Martinez bookings
('f1f1f1f1-2221-1111-1111-111111111111', 'BOOK-I9J0K1L2', 3, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-2222-2222-2222-222222222222', 't1t1t1t1-5552-1111-1111-111111111111'),
('f1f1f1f1-2222-1111-1111-111111111111', 'BOOK-M3N4O5P6', 2, 'CANCELLED', CURRENT_TIMESTAMP, 'd1d1d1d1-2222-2222-2222-222222222222', 't1t1t1t1-ccc2-1111-1111-111111111111'),

-- Carol Davis bookings
('f1f1f1f1-3331-1111-1111-111111111111', 'BOOK-Q7R8S9T0', 1, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-3333-3333-3333-333333333333', 't1t1t1t1-3331-1111-1111-111111111111'),
('f1f1f1f1-3332-1111-1111-111111111111', 'BOOK-U1V2W3X4', 1, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-3333-3333-3333-333333333333', 't1t1t1t1-7771-1111-1111-111111111111'),

-- Daniel Kumar bookings
('f1f1f1f1-4441-1111-1111-111111111111', 'BOOK-Y5Z6A7B8', 4, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-4444-4444-4444-444444444444', 't1t1t1t1-aaa3-1111-1111-111111111111'),

-- Emily Brown bookings
('f1f1f1f1-5551-1111-1111-111111111111', 'BOOK-C9D0E1F2', 2, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-5555-5555-5555-555555555555', 't1t1t1t1-8882-1111-1111-111111111111'),
('f1f1f1f1-5552-1111-1111-111111111111', 'BOOK-G3H4I5J6', 1, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-5555-5555-5555-555555555555', 't1t1t1t1-ccc1-1111-1111-111111111111'),

-- Frank Liu bookings
('f1f1f1f1-6661-1111-1111-111111111111', 'BOOK-K7L8M9N0', 2, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-6666-6666-6666-666666666666', 't1t1t1t1-5551-1111-1111-111111111111'),

-- Grace Lee bookings
('f1f1f1f1-7771-1111-1111-111111111111', 'BOOK-O1P2Q3R4', 1, 'CONFIRMED', CURRENT_TIMESTAMP, 'd1d1d1d1-7777-7777-7777-777777777777', 't1t1t1t1-3332-1111-1111-111111111111');
